...
function RageUI.PercentagePanelSpawn(Percent, HeaderText, MinText, MaxText, Action, Index)
    local CurrentMenu = RageUI.CurrentMenu
...
function RageUI.PercentagePanelSpawn(Percent, HeaderText, MinText, MaxText, Callback, Index)
    local CurrentMenu = RageUI.CurrentMenu
